...
<div class="jumbotron">
 ...
 <h2>Publikacja artykułu</h2>
    ...
    <form method="post" action="/index.php?action=article_create">
     ...
     <label for="author" class="col-sm-2 col-form-label">Autor</label>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="minipoint" name="minipoint" placeholder="Punkty">
            </div>
        </div>
<div class="form-group row">
		...
		<div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" step="1" class="form-control" id="publicdate" name="publicdate" placeholder="Data publikacji">
            </div>
        </div>
			<div class="form-group row">
